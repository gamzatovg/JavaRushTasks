...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            user.setBirthDate(new SimpleDateFormat("dd-MM-yyyy").parse("19-07-1992"));
            user.setCountry(User.Country.RUSSIA);
            user.setFirstName("Гамзат");
            user.setLastName("Гамзатов");
            user.setMale(true);
            ...
            //check here that javaRush object equals to loadedObject object - проверьте тут, что javaRush и loadedObject равн
